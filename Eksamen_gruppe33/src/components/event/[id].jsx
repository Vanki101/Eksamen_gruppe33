...
// Importerer ArtistCard-komponenten som brukes til å vise artister
import ArtistCard from "../artistcard"

// Hovedkomponent for å vise detaljer om et spesifikt event
export default function EventDetail() {
  ...
  useEffect(() => {
    ...
    const fetchEvent = async () => {
      try {
        // Henter detaljer om eventet basert på ID
        ...
        setLoading(false) // Setter loading til false når data er hentet eller ved feil
      }
    }
  ...
  // Logger eventet til konsollen for debugging
  console.log(event)
    ...
    <main className="event-container">
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Viser artister hvis det finnes noen tilknyttet eventet */}
